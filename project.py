...
# Lambda indirection method to avoid passing a copy of the overridable method when declaring the field
	...
	'responsible_id' : fields.function(_responsible_id,string='Person Responsible for Project', type = 'char'),
        ...
        'x_milestone': fields.char(string="Milestone", size=50),
	'x_redmine': fields.char(string="Redmine Link", size=1000),
        ...
        'x_sales_feedback': fields.selection([
            ('open','Open'),
            ('closed','Closed')
            ], 
            'Sales Feedback'),
        'x_project_phase': fields.selection([
            ('sales','Sales'),
            ('quote','Quote'),
            ('dev','Development'), 
            ('prod','Production'),
            ...
            'Phase', required=True,),
        'x_project_stage': fields.selection([
            ('rfi1','RFI1'),
            ('rfi2','RFI2'),
            ('rfi3','RFI3'),
            ('rfq1','RFQ1'),
        ...
        'x_CR_approved': fields.selection([
            ('yes','Yes'),
            ('no','No')
            ], 
            'CR Approved', required=True,),
        ...
        'project_status': fields.related('stage','project_status', readonly=True, type='char',relation='res.states', string='Project Status'),
	...
	'x_process_type': fields.selection([
        ...
        'x_cancel_date': fields.date(string="Cancel Date"),
        ...
        #stage gate requirement fields
        'x_kickoff_101': fields.char(string="Design or platform reuse analysis/decision", help="List of reuseable parts/modules, etc.", size=100),
        'x_kickoff_101_dev': fields.boolean(string="approval"),
        'x_kickoff_101_reason': fields.char(string="reason", size=100),

        'x_kickoff_102': fields.char(string="PRD",help="PRD template", size=100),
        'x_kickoff_102_dev': fields.boolean(string="approval"),
        'x_kickoff_102_reason': fields.char(string="reason", size=100),

        'x_kickoff_103': fields.char(string="GAP and risk Analysis ", size=100),
        'x_kickoff_103_dev': fields.boolean(string="approval"),
        'x_kickoff_103_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_105': fields.char(string="Kick off meeting", help= "Meeting minutes template", size=100),
        'x_kickoff_105_dev': fields.boolean(string="approval"),
        'x_kickoff_105_reason': fields.char(string="reason", size=100),

        

        'x_kickoff_201': fields.char(string="Sample requirement Plan", help="PJM template", size=100),
        'x_kickoff_201_dev': fields.boolean(string="approval"),
        'x_kickoff_201_reason': fields.char(string="reason", size=100),

        'x_kickoff_202': fields.char(string="Approval of All Test Plans",help="find from each functinal group", size=100),
        'x_kickoff_202_dev': fields.boolean(string="approval"),
        'x_kickoff_202_reason': fields.char(string="reason", size=100),

        'x_kickoff_203': fields.char(string="Cross-functional project review", help="Meeting minutes template (in Redmine)", size=100),
        'x_kickoff_203_dev': fields.boolean(string="approval"),
        'x_kickoff_203_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_204': fields.char(string="SER/Green compliance review", help= "MGreen portal, Quality to notify once done", size=100),
        'x_kickoff_204_dev': fields.boolean(string="approval"),
        'x_kickoff_204_reason': fields.char(string="reason", size=100),

        'x_kickoff_205': fields.char(string="Design spec/requirement freeze", help="PRD sign off by TPL/customer", size=100),
        'x_kickoff_205_dev': fields.boolean(string="approval"),
        'x_kickoff_205_reason': fields.char(string="reason", size=100),

        'x_kickoff_206': fields.char(string="Draft E-BOM release",help="excel sheet", size=100),
        'x_kickoff_206_dev': fields.boolean(string="approval"),
        'x_kickoff_206_reason': fields.char(string="reason", size=100),

        'x_kickoff_207': fields.char(string="P/D FMEA V0. review", help="PRD sign off by TPL/customer", size=100),
        'x_kickoff_207_dev': fields.boolean(string="approval"),
        'x_kickoff_207_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_208': fields.char(string="DFX V0 review", help= "Meeting minutes template", size=100),
        'x_kickoff_208_dev': fields.boolean(string="approval"),
        'x_kickoff_208_reason': fields.char(string="reason", size=100),

        'x_kickoff_209': fields.char(string="Design guide", size=100),
        'x_kickoff_209_dev': fields.boolean(string="approval"),
        'x_kickoff_209_reason': fields.char(string="reason", size=100),

        'x_kickoff_210': fields.char(string="Production plan", size=100),
        'x_kickoff_210_dev': fields.boolean(string="approval"),
        'x_kickoff_210_reason': fields.char(string="reason", size=100),

        'x_kickoff_211': fields.char(string="Vendor selection", size=100),
        'x_kickoff_211_dev': fields.boolean(string="approval"),
        'x_kickoff_211_reason': fields.char(string="reason", size=100),



        'x_kickoff_301': fields.char(string="LLT Mat approved by customer",  size=100),
        'x_kickoff_301_dev': fields.boolean(string="approval"),
        'x_kickoff_301_reason': fields.char(string="reason", size=100),

        'x_kickoff_302': fields.char(string="DFX Reviews", size=100),
        'x_kickoff_302_dev': fields.boolean(string="approval"),
        'x_kickoff_302_reason': fields.char(string="reason", size=100),

        'x_kickoff_303': fields.char(string="Engineering Builds Summary Report",  size=100),
        'x_kickoff_303_dev': fields.boolean(string="approval"),
        'x_kickoff_303_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_304': fields.char(string="Design verification report",  size=100),
        'x_kickoff_304_dev': fields.boolean(string="approval"),
        'x_kickoff_304_reason': fields.char(string="reason", size=100),

        'x_kickoff_305': fields.char(string="DV build Plan", size=100),
        'x_kickoff_305_dev': fields.boolean(string="approval"),
        'x_kickoff_305_reason': fields.char(string="reason", size=100),

        'x_kickoff_306': fields.char(string="DV quality planning", size=100),
        'x_kickoff_306_dev': fields.boolean(string="approval"),
        'x_kickoff_306_reason': fields.char(string="reason", size=100),

        'x_kickoff_307': fields.char(string="Cross-Functional  review", size=100),
        'x_kickoff_307_dev': fields.boolean(string="approval"),
        'x_kickoff_307_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_308': fields.char(string="Update pricing and Part Numbers in SAP", size=100),
        'x_kickoff_308_dev': fields.boolean(string="approval"),
        'x_kickoff_308_reason': fields.char(string="reason", size=100),



        'x_kickoff_401': fields.char(string="FAI of hard and/or soft tool",  size=100),
        'x_kickoff_401_dev': fields.boolean(string="approval"),
        'x_kickoff_401_reason': fields.char(string="reason", size=100),

        'x_kickoff_402': fields.char(string="TR - design signoff", size=100),
        'x_kickoff_402_dev': fields.boolean(string="approval"),
        'x_kickoff_402_reason': fields.char(string="reason", size=100),

        'x_kickoff_403': fields.char(string="Jig/assemply tool ready",  size=100),
        'x_kickoff_403_dev': fields.boolean(string="approval"),
        'x_kickoff_403_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_404': fields.char(string="SOP for production",  size=100),
        'x_kickoff_404_dev': fields.boolean(string="approval"),
        'x_kickoff_404_reason': fields.char(string="reason", size=100),

        'x_kickoff_405': fields.char(string="PFC", size=100),
        'x_kickoff_405_dev': fields.boolean(string="approval"),
        'x_kickoff_405_reason': fields.char(string="reason", size=100),

        'x_kickoff_406': fields.char(string="PTS ", size=100),
        'x_kickoff_406_dev': fields.boolean(string="approval"),
        'x_kickoff_406_reason': fields.char(string="reason", size=100),

        'x_kickoff_407': fields.char(string="Cross-Functional project review", size=100),
        'x_kickoff_407_dev': fields.boolean(string="approval"),
        'x_kickoff_407_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_408': fields.char(string="Safety application documents", size=100),
        'x_kickoff_408_dev': fields.boolean(string="approval"),
        'x_kickoff_408_reason': fields.char(string="reason", size=100),

        'x_kickoff_409': fields.char(string="Validation Testing and passed",  size=100),
        'x_kickoff_409_dev': fields.boolean(string="approval"),
        'x_kickoff_409_reason': fields.char(string="reason", size=100),

        'x_kickoff_410': fields.char(string="sign-off of all customer-specific requirements", size=100),
        'x_kickoff_410_dev': fields.boolean(string="approval"),
        'x_kickoff_410_reason': fields.char(string="reason", size=100),

        'x_kickoff_411': fields.char(string="Costing update ",  size=100),
        'x_kickoff_411_dev': fields.boolean(string="approval"),
        'x_kickoff_411_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_412': fields.char(string="ME release ",  size=100),
        'x_kickoff_412_dev': fields.boolean(string="approval"),
        'x_kickoff_412_reason': fields.char(string="reason", size=100),

        'x_kickoff_413': fields.char(string="List of Deficiencies", size=100),
        'x_kickoff_413_dev': fields.boolean(string="approval"),
        'x_kickoff_413_reason': fields.char(string="reason", size=100),

        'x_kickoff_414': fields.char(string="Customer Support Plan Review/Update", size=100),
        'x_kickoff_414_dev': fields.boolean(string="approval"),
        'x_kickoff_414_reason': fields.char(string="reason", size=100),

        'x_kickoff_415': fields.char(string="LLT Mat update", size=100),
        'x_kickoff_415_dev': fields.boolean(string="approval"),
        'x_kickoff_415_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_416': fields.char(string="Quality Assurance Plan Review/Update ", size=100),
        'x_kickoff_416_dev': fields.boolean(string="approval"),
        'x_kickoff_416_reason': fields.char(string="reason", size=100),

        'x_kickoff_417': fields.char(string="Cross-Functional project Review", size=100),
        'x_kickoff_417_dev': fields.boolean(string="approval"),
        'x_kickoff_417_reason': fields.char(string="reason", size=100),



        'x_kickoff_501': fields.char(string="Production Forecast Update",  size=100),
        'x_kickoff_501_dev': fields.boolean(string="approval"),
        'x_kickoff_501_reason': fields.char(string="reason", size=100),

        'x_kickoff_502': fields.char(string="Licensing Verification ", size=100),
        'x_kickoff_502_dev': fields.boolean(string="approval"),
        'x_kickoff_502_reason': fields.char(string="reason", size=100),

        'x_kickoff_503': fields.char(string="PP sample approval",  size=100),
        'x_kickoff_503_dev': fields.boolean(string="approval"),
        'x_kickoff_503_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_504': fields.char(string="PP cross-functional review meeting",  size=100),
        'x_kickoff_504_dev': fields.boolean(string="approval"),
        'x_kickoff_504_reason': fields.char(string="reason", size=100),

        'x_kickoff_505': fields.char(string="FAI of PP build", size=100),
        'x_kickoff_505_dev': fields.boolean(string="approval"),
        'x_kickoff_505_reason': fields.char(string="reason", size=100),

        'x_kickoff_506': fields.char(string="PP material tracking list inc. LLT", size=100),
        'x_kickoff_506_dev': fields.boolean(string="approval"),
        'x_kickoff_506_reason': fields.char(string="reason", size=100),

        'x_kickoff_507': fields.char(string="SAP BOM release to stage1", size=100),
        'x_kickoff_507_dev': fields.boolean(string="approval"),
        'x_kickoff_507_reason': fields.char(string="reason", size=100),
       
        'x_kickoff_508': fields.char(string="Final production assembly tool completed", size=100),
        'x_kickoff_508_dev': fields.boolean(string="approval"),
        'x_kickoff_508_reason': fields.char(string="reason", size=100),

        'x_kickoff_509': fields.char(string="Validation Testing and passed ",  size=100),
        'x_kickoff_509_dev': fields.boolean(string="approval"),
        'x_kickoff_509_reason': fields.char(string="reason", size=100),

        'x_kickoff_510': fields.char(string="Quality Assurance report ", size=100),
        'x_kickoff_510_dev': fields.boolean(string="approval"),
        'x_kickoff_510_reason': fields.char(string="reason", size=100),

        'x_kickoff_511': fields.char(string="Golden Reference sample selection",  size=100),
        'x_kickoff_511_dev': fields.boolean(string="approval"),
        'x_kickoff_511_reason': fields.char(string="reason", size=100),
    
        'x_kickoff_512': fields.char(string="Process capability report",  size=100),
        'x_kickoff_512_dev': fields.boolean(string="approval"),
        'x_kickoff_512_reason': fields.char(string="reason", size=100),

        'x_kickoff_513': fields.char(string="Cross-functional projectReview", size=100),
        'x_kickoff_513_dev': fields.boolean(string="approval"),
        'x_kickoff_513_reason': fields.char(string="reason", size=100),

        'x_kickoff_514': fields.char(string="Finalize BOM and cost against budget", size=100),
        'x_kickoff_514_dev': fields.boolean(string="approval"),
        'x_kickoff_514_reason': fields.char(string="reason", size=100),

        'x_kickoff_515': fields.char(string="Customer approval of MP", size=100),
        'x_kickoff_515_dev': fields.boolean(string="approval"),
        'x_kickoff_515_reason': fields.char(string="reason", size=100),
       


        'x_kickoff_601': fields.char(string="Lessons Learned Report",  size=100),
        'x_kickoff_601_dev': fields.boolean(string="approval"),
        'x_kickoff_601_reason': fields.char(string="reason", size=100),

        'x_kickoff_602': fields.char(string="Safe launch", size=100),
        'x_kickoff_602_dev': fields.boolean(string="approval"),
        'x_kickoff_602_reason': fields.char(string="reason", size=100),
     }
...
class task(base_stage, osv.osv):
	...
	'x_department' : fields.selection([('TYM Sourcing','TYM Sourcing'),('PMX Sourcing','PMX Sourcing'),('TE','TE'),('TE-BU','TE-BU'),('ME','ME'),('Sales','Sales'),('SE','SE'),('LSE','TPL'),('EE','EE'),('Team','Team'),('product pricing','Product Pricing'),('System PJM','System PJM'),('Transducer PJM','Transducer PJM'),('PE','PE'),('Customer_sales','Customer_sales'),('Customer_PJM','Customer_PJM')],'Department'),
        'x_issue' : fields.selection([('open','Open'),('closed','Closed'),('open-W','Open-W'),('closed-W','Closed-W'),('onhold','On Hold')],'Issue(Open/Closed)'),
        'x_quotation_stage' : fields.selection([('1st','1st'),('2nd','2nd'),('3rd','3rd'),('4th','4th'),('5th','5th'),('6th','6th'),('7th','7th'),('8th','8th'),('9th','9th'),('10th','10th')],'Quotation Stage'),
        'x_sales' : fields.selection([('open','Open'),('closed','Closed'),('onhold','On Hold')],'Sales(Open/Closed)'),
